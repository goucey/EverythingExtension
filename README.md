...
[![Build Status](https://git.okmn.cc/goucey/EverythingExtension/actions/workflows/release-auto.yml/badge.svg?event=push)](https://git.okmn.cc/goucey/EverythingExtension/actions?workflow=release-auto.yml)
